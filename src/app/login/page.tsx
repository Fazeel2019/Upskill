...
import { signInWithEmailAndPassword, signInWithPopup, AuthProvider as FirebaseAuthProvider } from "firebase/auth";
            ...
            <div className="w-full max-w-md">
                ...
                <Card>
                    <CardHeader className="text-center">
                        ...
                        <CardDescription>
                            Log in to access your professional community.
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                        ...
                        <Button variant="outline" className="w-full" onClick={() => handleSignIn(googleProvider)} disabled={isLoading}>
                            <GoogleIcon />
